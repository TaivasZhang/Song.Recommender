...
def get_segments_timbre(h5,songidx=0):
    ...
    """
    if h5.root.analysis.songs.nrows == songidx + 1:
        #print(h5.root.analysis.segments_timbre[h5.root.analysis.songs.cols.idx_segments_timbre[songidx]:,:])
        a = numpy.array(h5.root.analysis.segments_timbre[h5.root.analysis.songs.cols.idx_segments_timbre[songidx]:,:])
